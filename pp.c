...
{ 
int ch; 
int gd=DETECT,gm; int tx,ty,sx,sy; float theta; 
initgraph(&gd,&gm,"c:\\tc\\bgi"); 
setbkcolor(WHITE); setcolor(6); 
...
int refx,refy; theta=theta*(3.14/180); 
setcolor(2); 
